    ...
    public function testExecuteWithAdditionalBundles(): void
    {
        ...
        $expected = <<<'EOF'
            ...
            <container xmlns="http://symfony.com/schema/dic/services" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://symfony.com/schema/dic/services http://symfony.com/schema/dic/services/services-1.0.xsd">
              <services>
                <defaults autowire="true" autoconfigure="true" public="false"/>
                <prototype namespace="App\Core\" resource="../src" exclude="../src/Core/{DependencyInjection,Entity,Core.php}"/>
              </services>
            </container>
        ...
        $expected = <<<'EOF'
            ...
            <container xmlns="http://symfony.com/schema/dic/services" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://symfony.com/schema/dic/services http://symfony.com/schema/dic/services/services-1.0.xsd">
              <services>
                <defaults autowire="true" autoconfigure="true" public="false"/>
                <prototype namespace="App\Administration\" resource="../src" exclude="../src/Administration/{DependencyInjection,Entity,Administration.php}"/>
              </services>
            </container>
